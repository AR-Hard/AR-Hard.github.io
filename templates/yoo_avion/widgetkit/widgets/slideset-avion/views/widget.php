...
// Grid
$grid  = 'uk-grid uk-flex-center uk-grid-match uk-grid-width-1-'.$settings['columns'];
...
// Grid Divider
$grid_divider = ($settings['gutter'] == 'collapse' && $settings['grid_divider']) ? 'tm-grid-divider' : '';

?>

<div class="tm-slideset-avion <?php echo $grid_divider; echo $settings['class'] ? $settings['class'] : ''; ?>" data-uk-slideset="<?php echo $options; ?>">
    ...
    <div class="uk-slidenav-position">
        ...
        <ul class="uk-slideset <?php echo $grid; ?>" data-uk-grid-match="{target:'.uk-panel'}">
        <?php foreach ($items as $item) :
            ...
            <li<?php echo $filter; ?>>
                ...
                <div class="<?php echo $panel; ?><?php echo $panel_hover; ?> uk-text-<?php echo $settings['text_align']; ?>">
                    ...
                    <?php if ($item['date']) : ?>
                    <div class="uk-text-muted"><i class="uk-icon-calendar-o"></i> <?php echo $item['date']; ?></div>
                    <?php endif; ?>
        ...
        <?php if ($settings['slidenav'] == 'aside') : ?>
