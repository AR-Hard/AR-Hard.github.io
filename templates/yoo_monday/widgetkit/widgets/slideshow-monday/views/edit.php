    ...
    <div class="uk-width-medium-3-4">
        ...
        <ul id="nav-content" class="uk-switcher">
            <li>
                ...
                <div class="uk-form-row">
                    <label class="uk-form-label" for="wk-thumbnail-height">{{'Thumbnail Height (px)' | trans}}</label>
                    <div class="uk-form-controls">
                        <input id="wk-thumbnail-height" class="uk-form-width-medium" type="text" ng-model="widget.data['thumbnail_height']">
                    </div>
                </div>
